			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.raoxiaofeng.model.Order o=(com.raoxiaofeng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.raoxiaofeng.dao.UserDao userDao=new com.raoxiaofeng.dao.UserDao();
						...
						<%
							...
							String paymentType=com.raoxiaofeng.model.Payment.findByPaymentId(con,n);
							 %>
